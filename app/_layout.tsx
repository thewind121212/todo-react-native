...
import SQLite, { SQLiteDatabase, SQLiteProvider } from 'expo-sqlite';
import '@/lib/sheet';
...
async function checkIfTableExist(db: SQLiteDatabase, table: string) {
...
async function checkCountTable(db: SQLiteDatabase, table: string) {
